...
def manhattan_map() -> None:
    """
        Visualization of the number of taxi trips in each zone in Manhattan, with darker colors indicating more trips.
    """
...
def trips_by_week(database: DuckDBResource) -> None:
    """
        Get the number of taxi trips per week and aggregate metrics of those weeks
    """
